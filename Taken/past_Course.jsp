...
<body>
    ...
    <%
            ...
            ResultSet rs = statement.executeQuery("SELECT DISTINCT Course_ID, Term, Year_C, Title FROM OFFERING " +
            "WHERE Year_C < 2018 OR (Year_C = 2018 AND (Term = 'FALL' OR Term = 'WINTER'))");
    %>
    ...
    <table id="display">
        ...
        <form action="taken_form.jsp" method="get">
            <tr id="show">
