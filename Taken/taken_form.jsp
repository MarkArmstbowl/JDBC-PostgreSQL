...
<body>
    ...
    --%>
    <form action="taken_Insert.jsp" method="get">
        <div id="insert-form">
            <p>Please Enter Student ID, Select Sections & Grade Option and Enter Grade:</p>
            ...
            <%
                ...
                PreparedStatement unit1 = conn.prepareStatement(
                    ("SELECT * FROM COURSE_UNITS WHERE Course_ID = ?"));

                unit1.setString(1, request.getParameter("courseIDCL"));


                ResultSet offering_rs = offering.executeQuery();
                ResultSet unit1_rs = unit1.executeQuery();
            ...
            <table id="first_layer">
                ...
                <tr>
                    ...
                    <input id="grade_result" type="hidden" name="insert_grade_option">


                    <script>
                        var select1 = document.getElementById("gradeSelect");
                    ...
                    <th><input value="" name="grade_Insert" placeholder="Ex: A..B..C.."></th>
                    ...
                    <th>
                        <select id="unitSelect">
                            <option></option>
                            <% while(unit1_rs.next()) {%>
                                <option><%=unit1_rs.getString("Units")%></option>
                            <% } %>
                        </select>
                    ...
                    <input id="unit_result" type="hidden" name="insert_unit">


                    <script>
                        var select2 = document.getElementById("unitSelect");
                        
                        select2.addEventListener("change", function() {
                            
                            var selectedValue = select2.value;
                            
                            var result = document.getElementById("unit_result");
                            result.value = selectedValue;
                        });
                    </script>
