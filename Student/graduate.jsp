...
<body>
    ...
    <%
            ...
            ResultSet rs = statement.executeQuery("SELECT * FROM STUDENT_GRADUATE");
    %>
    ...
    --%>
    <form action="graduate_Insert.jsp" method="get">
        <div id="insert-form">
            ...
            <table id="first_layer">
                ...
                <tr>
                    ...
                    <th><input value="" name="type" placeholder="Ex: MS..."></th>
    ...
    <table id="display">
        ...
        <tr id="show">
            <form action="graduate_Update.jsp" method="get">
            ...
            <td><input size="9" value="<%=studentG_rs.getString("SSN")%>" name="SSN"></td>
            ...
            <td>
                <% while(type_rs.next()) { %>
                    <input size="18" value="<%= type_rs.getString("Type_S") %>" name="Type"><br>
                <% } %>
            </td>
            ...
            <form action="graduate_Delete.jsp" method="get">
