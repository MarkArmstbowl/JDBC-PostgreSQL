...
<body>
    ...
    <%
            ...
            ResultSet rs = statement.executeQuery("SELECT * FROM STUDENT_UNDERGRAD");
    %>
    ...
    --%>
    <form action="undergrad_Insert.jsp" method="get">
        <div id="insert-form">
    ...
    <table id="display">
        ...
        <tr id="show">
            <form action="undergrad_Update.jsp" method="get">
            ...
            <form action="undergrad_Delete.jsp" method="get">
