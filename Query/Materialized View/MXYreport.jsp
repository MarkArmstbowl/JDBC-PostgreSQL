...
<body>
    ...
    <%
        ...
        if (action != null && action.equals("Search")) {
            ...
            String grades = "Select * from CPG WHERE Course_Num = ? AND Instructor = ? AND N_Grade = ?";
    ...
    <p style="text-align: center;"> Grade Distribution of <%= cid %> Taught by <%= professor %> </p>
    ...
    <div>
        <table id="display">
            ...
            <tr>
                ...
                grades_s.setString(2, professor);
                grades_s.setString(3, "A");
