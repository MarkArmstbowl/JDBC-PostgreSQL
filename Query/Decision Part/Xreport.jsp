...
<body>
    ...
    <%
        ...
        if (action != null && action.equals("Search")) {
            ...
            String grades = "SELECT DISTINCT t.Student_ID, t.Course_Num, t.Grade FROM TAKEN t, OFFERING o WHERE o.Course_ID = ? AND o.Section_ID = t.Section_ID";
    ...
    <p style="text-align: center;"> Grade Distribution of <%= cid %> in Past Years</p>
