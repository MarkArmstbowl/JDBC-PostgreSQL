...
<body>
    ...
    <table id="displayss">
        <tr id="main_row">
            <th style="width:11%;">Course Number</th>
        ...
        <form action="XYZreport.jsp" method="get">
            <tr>
                <td><input name="courseNum" placeholder="Ex: CSE132B..."></td>
                <td><input name="professor" placeholder="Ex: John Smith.."></td>
    ...
    <table id="displayss">
        ...
        <form action="XYreport.jsp" method="get">
            <tr>
                <td><input name="courseNum" placeholder="Ex: CSE132B..."></td>
                <td><input name="professor" placeholder="Ex: John Smith.."></td>
                <td><input type="submit" value="Search" name="action"></td>
    ...
    <table id="displayss">
        ...
        <form action="Xreport.jsp" method="get">
            <tr>
                <td><input name="courseNum" placeholder="Ex: CSE132B..."></td>
                <td><input type="submit" value="Search" name="action"></td>
            </tr>
