...
<body>
    ...
    <%
        ...
        if (action != null && action.equals("Search")) {
            ...
            String grades = "SELECT DISTINCT t.Student_ID, t.Course_Num, t.Grade FROM TAKEN t, OFFERING o, CLASSES_SECTIONS c WHERE c.Instructor = ? AND c.Section_ID = o.Section_ID AND o.Course_ID = ? AND o.Term = ? AND o.Year_C = ? AND o.Section_ID = t.Section_ID";
            
            PreparedStatement grades_s = conn.prepareStatement(grades);
            grades_s.setString(1, professor);
            grades_s.setString(2, cid);
            grades_s.setString(3, quarter);
            grades_s.setInt(4, Integer.parseInt(year));
