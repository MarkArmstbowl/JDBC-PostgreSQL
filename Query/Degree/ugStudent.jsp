...
<body>
    ...
    <%
        ...
        PreparedStatement student = conn.prepareStatement(
            ...
            "FROM STUDENT s1, STUDENT_UNDERGRAD u1 " +
            "WHERE s1.Student_ID = u1.Student_ID " +
            "AND s1.Enroll = 'Enrolled'"
        );
        
        PreparedStatement under_degree = conn.prepareStatement(
            ("SELECT * FROM UnderGrad_Degree"));

        ResultSet student_rs = student.executeQuery();
        ResultSet under_degree_rs = under_degree.executeQuery();
    ...
    <div class="displayS">
        ...
        <label for="student">Please Select Undergraduate Student </label> <br>
        <select id="student">
            <option></option>
        ...
        <label for="bachelordegree">Please Select Bachelor Degree </label> <br>
        <select id="bachelordegree" >
            <option></option>

            <% while(under_degree_rs .next()) {%>

                <% 
                    String dep = under_degree_rs .getString("Department");
        ...
        <script>
            ...
            var select2 = document.getElementById("bachelordegree");
        ...
        <form action="ugStudent_display.jsp" method="get">
